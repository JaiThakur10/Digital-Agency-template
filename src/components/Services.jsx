...
import { MartiniIcon, MonitorPlay, Settings, Target, TargetIcon } from 'lucide-react'
    ...
    <div className=' h-full min-h-screen bg-white w-full'>
        ...
        <div className='  w-full h-[200px] flex  '>
            <div className=' w-[80%]  flex mx-[210px]  '>
                <div className='  flex  '>
                    <h1 className='  text-[#101010] font-!normal text-[90px] uppercase mt-8'>our services</h1>
                </div>
                ...
                <div className='  flex justify-center items-center w-[27%] ml-6'>
                    ...
                    Dive into our expertise in user experience optimization, digital strategy, and cutting-edge technology.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div className=' w-full h-[450px] flex'>
            ...
            <div className=' w-[28%] h-[90%] bg-[#FCBF4D] flex flex-col   mt-2 rounded-[1rem] border-black border-2'>
                ...
                <div className=' w-full h-[35%] flex flex-col'>
                    <h1 className=' font-!normal uppercase text-4xl ml-6'>Web design</h1>
                    <p className=' font-normal ml-6 '>From corporate sites to e-commerce platforms, we create stunning websites that captivate and convert.</p>
                </div>
            </div>
            <div className=' w-[28%] h-[90%] bg-[#FCBF4D] flex flex-col   mt-2 rounded-[1rem] border-black border-2'>
                <div className='  w-full h-[20%]'>
                ...
                <div className=' w-full h-[35%] flex flex-col'>
                    ...
                    <p className=' font-normal ml-6 '>We optimize your website to rank higher, driving more organic traffic and attracting qualified leads.</p>
                </div>
            </div>
            <div className=' w-[28%] h-[90%] bg-[#FCBF4D] flex flex-col   mt-2 rounded-[1rem] border-black border-2'>
                <div className='  w-full h-[20%]'>
                ...
                <div className=' w-full h-[35%] flex flex-col'>
                    <h1 className=' font-!normal uppercase text-4xl ml-6'>ux/ui design</h1>
                    <p className=' font-normal ml-6 '>From wireframing to prototyping, we focus on user-centric design to elevate your digital presence.</p>
                </div>
            </div>
